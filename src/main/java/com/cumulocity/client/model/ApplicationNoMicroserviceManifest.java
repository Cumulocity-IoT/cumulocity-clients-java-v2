...
public class ApplicationNoMicroserviceManifest {
	 ...
	 */
	@Deprecated
	private WebApplicationManifest manifest;
	...
	public WebApplicationManifest getManifest() {
		return manifest;
	}
	
	public void setManifest(final WebApplicationManifest manifest) {
	...
	public boolean equals(final Object r) {
		if (r != null && r instanceof ApplicationNoMicroserviceManifest) {
			ApplicationNoMicroserviceManifest comparer = (ApplicationNoMicroserviceManifest) r;
