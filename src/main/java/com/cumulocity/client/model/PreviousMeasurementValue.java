...
/**
 * <p>The read only fragment which contains the previous to latest measurements series values reported by the device.</p>
 * <blockquote>
...
public class PreviousMeasurementValue {
	...
	public PreviousMeasurementValue(final Number value) {
		this.value = value;
	}
	...
	public boolean equals(final Object r) {
		if (r != null && r instanceof PreviousMeasurementValue) {
			PreviousMeasurementValue comparer = (PreviousMeasurementValue) r;
