...
public class DeviceCredentialsApi extends AdaptableApi {
	 ...
	 * </blockquote>
	 * <blockquote>
	 * <p><strong>ⓘ Info:</strong> A bulk registration for <a href="#tag/Device-enrollment">certificate provisioning</a> creates temporary credentials for devices to authenticate</p>
	 * </blockquote>
